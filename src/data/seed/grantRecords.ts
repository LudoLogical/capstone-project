...
import type { GrantWritingAnalysis, GrantReportingAnalysis, GrantReportingConversation } from "@types-domain/analysis";
import { GRANT_HEALTHY_NEIGHBORHOODS, GRANT_FOOD_ACCESS, GRANT_GREEN_SPACES } from "./grants";
...
INITIATIVE_HILLTOP_WELLNESS.grantRecords.set(GRANT_HEALTHY_NEIGHBORHOODS.id, RECORD_HEALTHY_NEIGHBORHOODS);
INITIATIVE_HILLTOP_WELLNESS.grantRecords.set(GRANT_FOOD_ACCESS.id, RECORD_FOOD_ACCESS);
INITIATIVE_HILLTOP_WELLNESS.grantRecords.set(GRANT_GREEN_SPACES.id, RECORD_GREEN_SPACES);
