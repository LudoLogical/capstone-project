...
import { REGION_ALLEGHENY_COUNTY, REGION_PITTSBURGH, REGION_WESTMORELAND_COUNTY } from "./geo";
...
export const GRANT_FOOD_ACCESS: Grant = {
  ...
  requirements: {
    ...
    reporting: ["Submit one annual impact report at the end of the award term"],
  },
  guidance: {
    application: [
...
export const GRANT_YOUTH_DIGITAL_WELLNESS: Grant = {
  ...
  requirements: {
    ...
    reporting: ["Submit a final report within 45 days of award term end"],
  },
  guidance: {
    application: [
