...
export const STORIES: Story[] = [
  ...
  },
  {
    ...
    what: "found a collaborator through the portal and, applying together, won the $40,000 Green Spaces & Climate Resilience Fund.",
    tag: "Collaboration",
  ...
  },
  {
    ...
    what: "found the Youth Digital Wellness Grant through the portal and won it, funding a whole new after-school cohort.",
    tag: "Finding grants",
    ...
    body: [
      ...
      "Using the Vibrancy Portal's search, they described their program in plain language and let the tool rank grants by fit instead of scrolling through a directory sorted by deadline. The Youth Digital Wellness Grant surfaced near the top, its eligibility criteria matching almost exactly.",
      "They applied, using the portal to gather supporting evidence, and won. The award funded an entirely new after-school cohort for the following year.",
    ],
  },
];
