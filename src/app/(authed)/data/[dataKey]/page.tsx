 ...
 * "Share your context" step of the collect and report flows. On submit it
 * writes the values into the store (persisted to localStorage); the tab that
 * opened it picks the change up via the cross-tab storage listener in
 * StoreHydrator and flips its "Open form" control to "View summary".
 */
