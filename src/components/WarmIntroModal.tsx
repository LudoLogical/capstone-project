    ...
    <Modal open onClose={onClose} bare maxWidth="max-w-2xl">
      {sent ? (
        <div className="px-8 py-10 text-center">
          ...
          <button
            onClick={onClose}
            className="mt-5 rounded-lg bg-accent px-5 py-2.5 text-sm font-semibold text-white shadow-cta transition duration-150 hover:brightness-105"
          >
            Done
          </button>
        </div>
        ...
        <div>
          <div className="flex items-start gap-3 rounded-t-2xl bg-linear-to-r from-accent to-accent-ink px-7 py-5 text-white">
          ...
          <div className="px-7 py-6">
            ...
            <div className="mt-5 flex justify-end gap-2.5">
              ...
              <button
                onClick={send}
                className="inline-flex items-center gap-2 rounded-lg bg-accent px-5 py-2.5 text-sm font-semibold text-white shadow-cta transition duration-150 hover:brightness-105"
              >
                ➤ Send
              </button>
            </div>
...
function EmailRow({
  ...
  return (
    <div className="flex items-center gap-2.5 border-b border-divider py-2.5 text-sm">
      <span className="w-16 flex-none font-mono text-xs tracking-wide text-ink-faint">
        {label}
      </span>
