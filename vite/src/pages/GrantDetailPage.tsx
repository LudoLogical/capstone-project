    ...
    <div className="page-narrow page-enter">
      ...
      <div className="card" style={{ padding: 32, marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          <button
            onClick={() => navigate(`/grants/${grant.id}/collaborate`)}
      ...
      <div
        className="tag-row"
        style={{ flexDirection: "column", display: "flex", gap: 14 }}
      >
        <div className="card-ai">
          ...
          <button
            onClick={() => navigate(`/grants/${grant.id}/fit`)}
        ...
        <div className="card-ai">
          ...
          <button
            onClick={() => navigate(`/grants/${grant.id}/collect`)}
            className="btn btn-primary btn-sm"
          >
